    ...
    <div class="accountSecurity">
                        ...
                        <v-card style="padding: 24px;">
                            <v-layout row wrap>
                                ...
                                <v-flex xs2 class="text-xs-left">
                                    <v-btn small  color="yellow darken-1" style="min-width: 0px;">绑定</v-btn>
                                </v-flex>
                                ...
                                <v-flex xs2 class="text-xs-left">
                                    <v-btn small  color="yellow darken-1" style="min-width: 0px;" @click="accountSecurity.dialog = true">认证</v-btn>
                                </v-flex>
            ...
            <v-dialog v-model="accountSecurity.dialog" persistent max-width="800px">
                <v-card>
                            ...
                            <v-layout wrap>
                                <v-flex xs12>
                                    ...
                                    <v-form v-model="accountSecurity.form" ref="br" lazy-validation>
                                        ...
                                        <v-text-field label="银行卡账号" v-model="accountSecurity.bankCardAccount" placeholder="XXXX-XXXX-XXXX-XXXX" :counter="25" :rules="rules.bankCardAccount" ></v-text-field>
                                    ...
                                    <v-layout wrap>
                                        ...
                                        <v-flex xs4 >
                                            ...
                                            <v-card>
                                                ...
                                                <v-card-title primary-title>
                                                    <div>
                                                        <h3 v-if="bankCardFront.validate" class="subheading mb-0">银行卡信息</h3>
                                                        <h3 v-else class="subheading mb-0 red--text">请上传图片</H3>
                                                        <div class="caption grey--text">
                    ...
                    <v-card-actions>
                        <v-spacer></v-spacer>
                        <v-btn small flat @click="accountSecurity.dialog = false">取消</v-btn>
                        <v-btn small  color="yellow darken-1" style="min-width: 0px;" @click="accountSecurity.dialog = true; InfoAuth()" >申请认证</v-btn>
                    </v-card-actions>
                </v-card>
...
export default {
    ...
    methods: {
        ...
        fileChange() {
                ...
                store.dispatch('getWriteAccountStsToken')
                .then((res)=> {
        ...
        //     .then((res)=> {
        //         // console.log('hho')
        //         // this.IDCardFront.progress = 1;
        //         // console.log(this[this.uploadMap].file.progress)
        //         this.$store.dispatch('uploadFile',{callbackUrl:'60.205.225.197/osscallback', objectKey:`temporaryFile/account/${this.$store.state.user._id}/authenticate/${this.uploadMap}`, file: this[this.uploadMap]});
        //     });
        // },
        ...
        InfoAuth() {
            ...
            this.$store.dispatch('putRealInformation', {name: this.accountSecurity.name, IDNumber: this.accountSecurity.IDNumber, bankCardAccount: this.accountSecurity.bankCardAccount, openingBank: this.accountSecurity.openingBank});
